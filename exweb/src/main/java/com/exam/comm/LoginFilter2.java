...
import com.exam.student.StudentVo;
...
public class LoginFilter2 implements Filter{
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		whiteList.add("/student/login.do");
		whiteList.add("/student/add.do");
	}
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if(whiteList.contains(reqUri)==false) {
			...
			///////////////////////////////////////////////////////////////////////	
				...
				StudentVo vo = (StudentVo) session.getAttribute("loginUser");
				
				if(vo==null) {
					//(로그인한적 없다면)
					//loginUser가 없는경우 로그인화면으로 보낸다.
					resp.sendRedirect(req.getContextPath()+"/student/login.do");
